...
export default {
  ...
  head() {
    return {
      titleTemplate: '%s | AGV Sistemleri'
    }
  },
  created() {
    this.links = [
...
<template>
  <section class="sub-service">
    <app-banner 
      content="Hizmetler" 
      image-source="https://images.unsplash.com/photo-1496247749665-49cf5b1022e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZmFjdG9yeXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" 
    />
    <b-container>
      <div class="breadcrumb-container">
        <b-breadcrumb :items="links" />
      </div>
      <app-title text="AGV Sistemleri" />
      <div class="content">
