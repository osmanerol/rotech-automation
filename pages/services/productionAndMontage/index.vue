...
export default {
  ...
  head() {
    return {
      titleTemplate: '%s | Üretim ve Montaj Hattı'
    }
  },
  created() {
    this.links = [
...
<template>
  <section class="sub-service">
    <app-banner 
      content="Hizmetler" 
      image-source="https://images.unsplash.com/photo-1589320011103-48e428abcbae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGZhY3Rvcnl8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" 
    />
    <b-container>
      <div class="breadcrumb-container">
        <b-breadcrumb :items="links" />
      </div>
      <app-title text="Üretim ve Montaj Hattı" />
      <div class="content">
