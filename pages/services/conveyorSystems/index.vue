...
export default {
  ...
  head() {
    return {
      titleTemplate: '%s | Konveyör Sistemleri'
    }
  },
  created() {
    this.links = [
...
<template>
  <section class="sub-service">
    <app-banner 
      content="Hizmetler" 
      image-source="https://images.unsplash.com/photo-1535923430552-0ce3cd477cc7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y29udmV5b3J8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" 
    />
    <b-container>
      <div class="breadcrumb-container">
        <b-breadcrumb :items="links" />
      </div>
      <app-title text="Konveyör Sistemleri" />
      <div class="content">
